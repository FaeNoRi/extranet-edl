{{-- Contenu partagé entre formateur.seances.show et admin.seances.show. --}}
@php $prefix ??= 'formateur'; @endphp
...
<div class="flex flex-wrap items-start justify-between gap-3">
    ...
    <div class="flex gap-2">
        <a href="{{ route("{$prefix}.seances.fiche", $seance) }}"
        ...
        <ul class="divide-y divide-gray-100 text-sm">
            @foreach ($seance->ressources as $ressource)
                <li class="flex items-center justify-between py-2">
                    ...
                    <a href="{{ route("{$prefix}.ressources.download", $ressource) }}" class="text-edl-bleu hover:underline">Télécharger</a>
                </li>
            @endforeach
        </ul>
    @endif
